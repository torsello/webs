...
if(isset($_SESSION['logged_in'])){
    ...
    if(isset($_GET['titulo']) and isset($_GET['desc'])){
        ...
        if(empty($_GET['titulo'] or $_GET['desc'])){
            ...
            $query=$pdo->prepare('UPDATE resparticulares SET resParticularesTitulo = ?, resParticularesDesc = ? WHERE idParticulares = 1');
...
<h4 style="color:white;">Editar informaci&oacute;n: Particulares</h4>
...
<form class="usform" action="editParticulares.php" method="GET" autocomplete="on">
<label style="color:white;" for="titulo">T&iacute;tulo</label>
<input class="form-control" type="text" name="titulo" value="<?php echo $particular['resParticularesTitulo']?>"/>
<label style="color:white;" for="desc">Descripci&oactute;n</label>
​<textarea class="form-control" rows="10" cols="70" name="desc"><?php echo $particular['resParticularesDesc']?></textarea>
