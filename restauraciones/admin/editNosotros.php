...
if(isset($_SESSION['logged_in'])){
    ...
    if(isset($_GET['titulo']) and isset($_GET['desc'])){
        ...
        if(empty($_GET['titulo'] or $_GET['desc'])){
            ...
            $query=$pdo->prepare('UPDATE resnosotros SET resNosotrosTitulo = ?, resNosotrosDesc = ? WHERE idNosotros = 1');
...
<h4 style="color:white;">Editar informaci&oacute;n: Nosotros</h4>
...
?>
<form class="usform" action="editNosotros.php" method="GET" autocomplete="on">
<label style="color:white;" for="titulo">T&iacute;tulo</label>
<input class="form-control" type="text" name="titulo" value="<?php echo $nosotros['resNosotrosTitulo']?>"/>
<label style="color:white;" for="desc">Descripci&oacute;n</label>
​<textarea class="form-control" rows="10" cols="70" name="desc"><?php echo $nosotros['resNosotrosDesc']?></textarea>
